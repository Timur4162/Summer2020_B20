...
public class Addition {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String a = input.next().toLowerCase();  // to make it in LOWER CASE

            while ( !(a.equals("yes") || a.equals("no")) ){ // while the answer is INVALID will executes INFINITE time
                // needs grouping because of the opposite
                ...
                if (a.equals("no")) {
                    break;              // if use the system.exit ==> the whole programm will be stopped
                }
