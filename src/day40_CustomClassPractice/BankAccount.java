...
public class BankAccount {
    ...
    public void setAccountInfo(String clientAccountType, String name, String acctNum) {
        ...
        accountHolder = name;
        accountNumber = acctNum; // use the String just because for display info
    }

    public void getAccountInfo() {  // CALL METHOD == displays account INFO
        System.out.println("================================");
    ...
    public void deposit(double amount){
        System.out.println("Depositing $" + amount + " to" + accountType);
        balance += amount;
    }
    ...
    public void withDraw(double amount){
        if (amount > balance){
            ...
            return;  // to stop the method right away
        }
