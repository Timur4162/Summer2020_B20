...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        ;
        offer3.setOfferInfo(125000, "VA", true, true, true, "SDET", false);
        ...
        // jobOffers.removeIf(p -> p.salary < 120000 || !p.state.equals("VA")); //  MUST EQUAL METHOD not the operator '='
        //System.out.println("Numbers of offers: " + jobOffers.size());


        // ==== does not have PTO or does not have Benefits or is not full time  ======= CONDITION

        jobOffers.removeIf(p -> p.hasPTO == false || p.hasBenefits == false || p.isFullTime == false||p.salary<120000);
        System.out.println("Numbers of offers: " + jobOffers.size());
