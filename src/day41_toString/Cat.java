...
public class Cat {
    ...
    public String toString() { // will be executed automatically when theCat object is passed in the print statement
        return "Name of the cat: " + name + ", age: " + age + ", gender: " + gender + ", color: " + color + ", breed: " + breed + "| ";
    }
