...
public class CapitalOne {
    public static void main(String[] args) {
        ...
        developers[3].setInfo("Virginia", 'F',763554,"Dev", 120500);
        ...
        for (Tester each : team1.testers){  // each : every single tester in a Scrum team
            System.out.println(each.name + " : $" + each.salary);
        }

        System.out.println("================================================");

        for (Developer each : team1.developers){  // each : every single developer in a Scrum team
            System.out.println(each.name + " : $" + each.salary);
        }
        System.out.println("================================================");
        ...
        dev1.setInfo("Luisa",'F',2122L, "Dev Lead", 500000);
